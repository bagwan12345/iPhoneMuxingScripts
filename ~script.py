...
class ImageComparisonApp:
    def __init__(self, root, images, videos):
        ...
        self.confirm_button = tk.Button(button_frame, text="These look similar", command=self.on_confirm, width=20, height=2, bg='#5389c2', fg='white', font=('Arial', 10, 'bold'))
        self.confirm_button.pack(side='top', pady=5)

        self.skip_button = tk.Button(button_frame, text="Skip", command=self.next_pair, width=20, height=2, bg='#5389c2', fg='white', font=('Arial', 10, 'bold'))
